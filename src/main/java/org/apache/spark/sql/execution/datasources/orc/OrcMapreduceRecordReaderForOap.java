 ...
 * to have child class OrcMapreduceRecordReaderForOapIndex.
 ...
 */
public class OrcMapreduceRecordReaderForOap<V extends WritableComparable>
  ...
  public OrcMapreduceRecordReaderForOap(Path file, Configuration conf)
      throws IOException {
